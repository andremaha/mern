...
router.put('/education', [auth, 
	check('school', 'What school did you go to?')
	.not()
	.isEmpty(),
	check('degree', 'What was your degree?')
	.not()
	.isEmpty(),
	check('fieldofstudy', 'What was the field of study?')
	.not()
	.isEmpty(),
	check('from', 'When did you go to school?')
	.not()
	.isEmpty()
	], 
	async (req, res) => {
